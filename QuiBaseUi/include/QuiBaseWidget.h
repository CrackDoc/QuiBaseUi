#ifndef QuiBaseWidget_h__
#define QuiBaseWidget_h__
...
namespace Ui 
{
	class QuiBaseWidgetClass;
}
class QuiBaseUi_EXPORT CQuiBaseWidget : public QWidget
{
	Q_OBJECT

public:
	CQuiBaseWidget(QWidget *parent = 0);
	~CQuiBaseWidget();
...
private:
	...
	// 获取鼠标窗口阴影
	CQuiBaseWidget::Direction GetBorderDirection(QMouseEvent * mouseEvent);
	// 设置鼠标样式
